...
class Referente(models.Model):
    ...
    parroquia = models.ForeignKey('Parroquia', on_delete=models.CASCADE, default='S/N')
...
class Telefono(models.Model):
    ...
    def __str__(self):
        return f"{self.tipo_telefono}, {self.numero_de_telefono}"
